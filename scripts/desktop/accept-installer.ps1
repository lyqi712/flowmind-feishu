...
function Test-InstalledRouteContracts {
  ...
  $contracts = @(
    ...
    [pscustomobject]@{ method = 'GET'; route = '/api/agent/capabilities'; token = "app.get('/api/agent/capabilities'," },
    [pscustomobject]@{ method = 'GET'; route = '/api/agent/runs/:id'; token = "app.get('/api/agent/runs/:id'," },
    [pscustomobject]@{ method = 'POST'; route = '/api/agent/runs/:id/decision-note'; token = "app.post('/api/agent/runs/:id/decision-note'," }
  )
