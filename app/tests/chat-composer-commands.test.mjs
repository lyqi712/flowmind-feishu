...
test('\u56de\u7b54\u652f\u6301 Markdown \u6392\u7248\u5e76\u63d0\u4f9b\u66f4\u6709\u4eba\u60c5\u5473\u7684\u4efb\u52a1\u8d77\u70b9', () => {
  ...
  assert.ok(source.includes("id: 'auto'"));
  assert.ok(!source.includes('composer-mode-switch'));
  assert.ok(!source.includes('composer-skill-shortcut'));
  ...
  assert.match(source, /scrollTranscriptToEnd/);
});
